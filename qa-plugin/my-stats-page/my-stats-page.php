...
class my_stats_page
{
	...
	public function process_request($request)
	{
		...
		$qa_content['title']=qa_lang_html('my_stats_page/page_title');
		...
		$qa_content['custom_3']='<p><br>Even More <i>custom html</i></p>';
		
		$qa_content['error']='An example of another error';
		return $qa_content;
	}
}
